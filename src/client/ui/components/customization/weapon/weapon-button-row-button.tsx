...
import { CustomizationState, selectWeaponCustomizationPage } from "client/store/customization";
...
interface ButtonRowButtonProps {
	title: string;
	page: CustomizationState["weaponSelectedPage"];
	icon: keyof typeof images.ui.icons;
	selectedIcon?: keyof typeof images.ui.icons;
}

export function WeaponButtonRowButton({ title, page, icon, selectedIcon }: ButtonRowButtonProps) {
	const rem = useRem();
